...
--  $Id: coldframe-navigate_from_many_collection.ads,v 13badf447884 2001/08/16 19:31:36 simon $

--  This package supports navigation of a many-to-one association from
--  a set of instances of the 'many' end to the set of instances at
--  the 'one' end.
--
...
generic
   ...
   --  The abstract Container package for the 'many' end of the
   --  association
   ...
   with function Navigate_From_Many (S : Many_Handle) return One_Handle;
...
function ColdFrame.Navigate_From_Many_Collection (Input : From) return To;
