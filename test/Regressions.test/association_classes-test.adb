...
package body Association_Classes.Test is
   ...
   begin
      AC := A4.A4L (A_L => null);
      Assert (C,
              A4_Class.Collections.Length (AC) = 0,
   ...
   begin
      AC := A6.A6L (A_L => null);
      Assert (C,
              A6_Associative.Collections.Length (AC) = 0,
   ...
   begin
      ...
      Assert (C,
              A7_Associative.Collections.Length (AC) = 0,
   ...
   begin
      AC := A8.A8L (A_L => null);
      Assert (C,
              A8_Associative.Collections.Length (AC) = 0,
