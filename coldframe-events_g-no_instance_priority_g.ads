...
--  $RCSfile: coldframe-events_g-no_instance_priority_g.ads,v $
--  $Revision: 8c0b70769d31 $
--  $Date: 2006/10/31 06:44:55 $
--  $Author: simonjwright $

--  This Event Queue has the same behaviour as the Standard queue up
--  to and including release 20060427, that is, both Class and
--  Instance events are queued at the same priority, and is offered
--  for use if you rely on (have worked round) that behaviour.
--
--  ColdFrame bug #0359, SourceForge 1544856.
...
package ColdFrame.Events_G.No_Instance_Priority_G is
...
end ColdFrame.Events_G.No_Instance_Priority_G;
