...
function ColdFrame.Navigate_From_One_To_Many_Collection
  (Input : From) return To is
   ...
   --  'one' end of the association to the intermediate result set.
   ...
   --  the corresponding set of 'many' instances, and adding them to
   --  the result.
...
begin
   Generate_Result (It);
   return Result;
end ColdFrame.Navigate_From_One_To_Many_Collection;
