...
--  $Id: coldframe-navigate_from_one_to_one_collection.adb,v 13badf447884 2001/08/16 19:31:36 simon $
...
function ColdFrame.Navigate_From_One_To_One_Collection
  (Input : From) return To is
   ...
   --  Iterates over the input, navigating from each 'first' instance
   --  to the corresponding set of 'second' instances, and adding them
   --  to the result.
