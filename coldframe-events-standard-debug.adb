...
--  $RCSfile: coldframe-events-standard-debug.adb,v $
...
package body ColdFrame.Events.Standard.Debug is
   ...
   begin
      ...
      Standard.Post (The => The,
                     On => Standard.Event_Queue (On.all)'Access);
